...
file_path = 'Sources/Views/AddressAutocompleteView.swift'
file_ref = views_group.files.find { |f| f.path == file_path || f.real_path.to_s.end_with?('AddressAutocompleteView.swift') }

if file_ref.nil?
  file_ref = views_group.new_file('AddressAutocompleteView.swift')
  puts "Added file reference for AddressAutocompleteView.swift"
end
...
if !sources_build_phase.files_references.include?(file_ref)
  ...
  puts "Added AddressAutocompleteView.swift to compile sources"
end
